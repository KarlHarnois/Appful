...
public typealias User = (firstName: String, lastName: String)

public func fetchAccount(token: String, _ completionHandler: JsonTaskCompletionHandler) -> NSURLSessionDataTask? {
...
public func userModel(json: NSData) -> User? {
